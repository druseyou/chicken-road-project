...
const statusBadgeVariants = cva(
  'inline-flex items-center justify-center font-medium rounded-full transition-colors whitespace-nowrap select-none',
  {
    variants: {
      variant: {
...
const StatusBadge = React.forwardRef<HTMLSpanElement, StatusBadgeProps>(
  ({ className, variant, size, children, rank, ...props }, ref) => {
