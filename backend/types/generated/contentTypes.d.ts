...
export interface ApiBonusBonus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bonus_type: Schema.Attribute.Enumeration<
      ['deposit', 'no-deposit', 'cashback', 'free-spins', 'welcome', 'reload']
    > &
      Schema.Attribute.Required;
...
export interface ApiCasinoReviewCasinoReview
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currencies: Schema.Attribute.JSON;
    description: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
    detailed_review: Schema.Attribute.RichText;
    established_date: Schema.Attribute.Integer;
    ...
    payout_speed: Schema.Attribute.String;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    author_email: Schema.Attribute.Email & Schema.Attribute.Required;
    ...
    status: Schema.Attribute.Enumeration<['published', 'pending', 'rejected']> &
...
export interface ApiSlotSlot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demo_link: Schema.Attribute.String;
    description: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    ...
    meta_description: Schema.Attribute.Text;
    meta_title: Schema.Attribute.String;
    min_bet: Schema.Attribute.Decimal;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
    ...
    paylines: Schema.Attribute.Integer;
    ...
    rating: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    reels: Schema.Attribute.Integer;
